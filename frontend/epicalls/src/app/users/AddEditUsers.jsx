...
function AddEditUsers({ setAddEditModalUsers }) {
  ...
  return (
    <div className="bg-white left-0 right-0 top-0 bottom-0 flex fixed z-50">
      <div className="bg-white rounded-2xl shadow-xl box-content flex-col m-auto w-4/6 relative ">
        ...
        <form className="w-full overflow-x-hidden p-5 rounded-b-2xl flex-col" onSubmit={handleSubmitUser}>
          ...
          />
              ...
              <input type={showPassword ? 'text' : 'password'} className="border w-80 px-2" />
            </div>
